...
class ManualSaveFileImporter @Inject constructor(
    ...
    fun import(uri: Uri, emulator: Emulator): SaveFile? {
        // Both flags, not just read: this URI becomes the game's real save
        // path, and ActivateSaveSlotUseCase/BackupSaveUseCase need to write
        // back to it later via RealSaveAccess.
